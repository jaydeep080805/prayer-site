...
function AboutSikhism() {
  return (
    <PageLayout heading="about sikhism">
      {aboutSikhismData.map((section) => (
        <Section key={section.text} text={section.text} />
      ))}
    </PageLayout>
  );
}
