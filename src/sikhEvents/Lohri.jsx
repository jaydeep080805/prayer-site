  ...
  return (
    <PageLayout heading={"lohri - A Punjabi Winter Solstice Celebration"}>
      ...
      <ContentWithSubheading
        ...
        text={
          "The origins of Lohri are many and varied, with links to the Punjab region's agricultural way of life. It is traditionally associated with the harvest of the rabi crops. Celebrations include singing folk songs, dancing, and the iconic bonfire, which is symbolic of the festival. The fire is a sign of homage to the Sun God for gracing the earth with warmth, facilitating the harvest."
        }
      />
      ...
      <ContentWithSubheading
        ...
        text={
          "A feast is a significant part of Lohri celebrations, with traditional Punjabi dishes taking center stage. Sarson da Saag with Makki di Roti, complemented by a dollop of butter or ghee, is a must-have. The festival is particularly special for newly married couples and families with new babies, marking their first Lohri as a significant milestone."
        }
      />
