  ...
  return (
    ...
    >
      ...
      <ContentWithSubheading
        ...
        text={
          "Vaisakhi, also known as Baisakhi, is one of the most important dates in the Sikh calendar, commemorating the founding of the Khalsa Panth by Guru Gobind Singh Ji in 1699. It marks the Sikh New Year and celebrates the spring harvest. Vaisakhi gathers a profound religious significance alongside its cultural festivities, reflecting the rich heritage of the Sikh community."
        }
      />
      ...
      <ContentWithSubheading
        ...
        text={
          "Vaisakhi holds dual significance for Sikhs: it is both a religious and cultural festival. Religiously, it celebrates the creation of the Khalsa, a community of committed Sikhs who are ready to sacrifice their lives for their faith. Culturally, it marks the start of the harvest season, symbolizing prosperity, and renewal. It's a day of thanksgiving and joy, where Sikhs reflect on their identity and commitments."
        }
      />
