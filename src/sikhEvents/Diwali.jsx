  ...
  return (
    ...
    >
      ...
      <ContentWithSubheading
        ...
        text={
          "Bandi Chhor Divas offers a moment to reflect on the themes of freedom, justice, and the fight against oppression. It encourages Sikhs to remember the sacrifices made by their Gurus for the sake of humanity and to continue their legacy of fighting for the rights and dignity of all people."
        }
      />
    </PageLayout>
  );
