  ...
  return (
    ...
    >
      <ContentWithSubheading
        ...
        text={
          "Hola Mohalla, also known as Hola, is a Sikh festival that takes place on the first month of Chet in the Nanakshahi calendar, which corresponds to March in the Gregorian calendar. Instituted by Guru Gobind Singh Ji, the festival is celebrated with great fervor at Anandpur Sahib, Punjab, and signifies the martial spirit of the Sikhs through displays of traditional warfare, kirtan, and poetry."
        }
      />
