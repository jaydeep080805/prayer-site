  ...
  return (
    ...
    >
      ...
      <ContentWithSubheading
        ...
        text={
          "Guru Nanak’s message of 'Ek Onkar' (there is only one God) and his emphasis on the equality of all humanity regardless of caste, creed, or gender, continue to inspire millions. His teachings encourage us to look beyond our differences and work towards a world marked by compassion, service, and understanding."
        }
      />
    </PageLayout>
  );
