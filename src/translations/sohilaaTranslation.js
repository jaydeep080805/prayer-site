const sohilaaTranslation = {
  ...
  englishMeaning: [
    ...
    "The seconds, minutes and hours, days, weeks and months, and the various seasons originate from the one sun; 0 Nanak, in just the same way, the many forms originate from the Creator. ||2||2||",
...
export default sohilaaTranslation;
